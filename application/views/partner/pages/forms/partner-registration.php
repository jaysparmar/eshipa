                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" readonly name="latitude" min="0" step="0.000000000000000001" id="city_lat" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="longitude">Longitude <span class='text-danger text-sm'>*</span></label>
                                                    <input type="number" min="0" step="0.000000000000000001" readonly class="form-control" name="longitude" id="city_long" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
