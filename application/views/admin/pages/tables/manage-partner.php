                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools row ">
                                <a href="<?= base_url() . 'admin/partners/manage-partner' ?>" class="btn btn-block  btn-outline-info btn-sm">Add Spaza </a>
                            </div>
                        </div>
                        <div class="card-innr">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="settle_commission" class="col col-form-label">Settle Payments for Spazas</label>
                                    <div class="col-md-8">
                                        <a href="#" class="btn btn-info update-partner-commission" title="If you found partner Payment not crediting using cron job you can update Spazas Payments from here!">Settle Spazas Payment</a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label for="status_filter" class="col-form-label">Filter By Spaza Status</label>
                            ...
                            <table class='table-striped' id='seller_table' data-toggle="table" data-url="<?= base_url('admin/partners/view_partners') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="sd.id" data-sort-order="DESC" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="partner_query_params">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="licence_name" data-sortable="true" data-visible="false">Company Name</th>
                                        <th data-field="licence_code" data-sortable="true" data-visible="false">Registration Number</th>
                                        <th data-field="id_passport_number" data-sortable="true" data-visible="false">ID/Passport Number</th>
