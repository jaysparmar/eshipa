                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/area/add_city'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <label for="cities">Releted Deliverable Cities <span class='text-danger text-sm'>*</span></label>

                                    <select name="bordering_city_ids[]" id="bordering_city_ids" class="search_city w-100 form-control" multiple onload="multiselect()">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <ol>
                                ...
                                <li>Releted Deliverable Cities: Hre you have to set reletedd city which are nearby city.This city you can add befire main city. </li>
                                ...
                                <li>By adding this <strong> Releted Deliverable Cities</strong> All partners which are in these cities, they al will list in application.</li>
                            </ol>
                        </div>
                    </div>
                </div>
