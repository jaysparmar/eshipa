                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php } ?>
                                        <div class="form-group">
                                            <label for="description" class="col-sm-3 col-form-label">Description <span class='text-danger text-sm'>*</span></label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 map-div">
                                                <label for="city_name">Search Spaza Location</label>
                                                <input id="city-input" type="text" class="form-control" placeholder="Enter Spaza Location" autocomplete="off" />
                                                </br>
                                                <span class="text text-primary">Search your spaza location and you will get the location points(Latitude & Longitude) below.</span>
                                            </div>
                                            <div class="col-md-8">
                                                <div id="map"></div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group ">
                                            <input type="hidden" id="id_passport_verified" name="id_passport_verified" value="<?= isset($fetched_data[0]['id_passport_number_status']) && $fetched_data[0]['id_passport_number_status'] == 1 ? 1 : 0 ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-info" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Spaza' : 'Add Spaza' ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
