                        ...
                        <div class="card card-info">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="is_partner_app_maintenance_mode_on"> Spaza App Maintenance Mode
                                        </label>
                                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <a class="btn btn-xs btn-info text-white" data-toggle="modal" data-target="#howItWorksModal" title="How it works">How spaza will get payment?</a>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">How spaza will get payment?</h4>
                ...
                <div class="modal-body ">
                    <ol>
                        <li>
                            Cron job must be set (For once in a day) on your server for spaza to be work.
                        </li>
                        <li>
                            Cron job will run every mid night at 12:00 AM.
                        </li>
                        <li>
                            Formula for spaza Payment is <b>Final Total (Excluding delivery charge) / 100 * spaza commission percentage</b>
                        <li>
                            <strong> Admin </strong> can view his commission in manage spaza page. And <strong> spaza </strong> can view admin commission on his profile section.
                        </li>
                        </li>
                        <li>
