<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Delivery Methods Settings</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/home') ?>">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Delivery Methods Settings</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="local_shipping_method">Enable Fastlane Delivery <small> ( Use Local Delivery Boy For Shipping) </small>
                                        </label>
                                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success" id="submit_btn">Update Delivery Settings</button>
                                    </div>
                                </div>
