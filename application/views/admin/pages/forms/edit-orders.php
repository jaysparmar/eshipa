                                            ...
                                            <div class="card card-widget widget-user-2">
                                                ...
                                                <div class="card-footer p-0">
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">User eZaka Balance(<?= $settings['currency'] ?>)<span class="float-right text-info"><?= number_format($order_detls[0]['user_balance'], 2); ?></span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
