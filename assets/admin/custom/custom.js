...
if (document.getElementById("dropzone")) {
    var myDropzone = new Dropzone("#dropzone", {
        ...
        uploadMultiple: true,
        dictDefaultMessage:
            '<p><input type="submit" value="Select Files" class="btn btn-info" /><br> or <br> Drag & Drop Media Files Here</p>'
    });
...
if (document.getElementById("system-update-dropzone")) {
    var systemDropzone = new Dropzone("#system-update-dropzone", {
        ...
        uploadMultiple: true,
        dictDefaultMessage:
            '<p><input type="submit" value="Select Files" class="btn btn-info" /><br> or <br> Drag & Drop System Update / Installable / Plugin\'s .zip file Here</p>'
    });
